	...
	\section{Eksperyment}
		...
		\begin{figure}[!h]
			\begin{minipage}{0.48\linewidth}
				\begin{tikzpicture}
					\begin{axis}[xlabel=Liczba detektorów, ylabel=RMSE, only marks, xtick distance=90]
					\addplot coordinates {
			...
			\begin{minipage}{0.48\linewidth}
				\begin{tikzpicture}
					...
					\addplot coordinates {
						(	90	,	0.40514008531762963	)
						(	180	,	0.4303860322190707	)
						(	270	,	0.4074154900101807	)
						(	360	,	0.4325980832846058	)
						(	450	,	0.43395246125538883	)
					};
					\end{axis}
				\end{tikzpicture}
			\end{minipage}
